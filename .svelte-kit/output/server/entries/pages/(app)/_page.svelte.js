...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${validate_component(Seo, "Seo").$$render($$result, {}, {}, {})} ${validate_component(ContainerLayout, "ContainerLayout").$$render($$result, {}, {}, {
    column: () => {
      return `<div slot="column"><h1 data-svelte-h="svelte-ea3fqt">Milwaukee Brew Cruisers Bike Ride</h1> <h2 class="subtitle pb-5" data-svelte-h="svelte-8e56nk">A monthly ride to enjoy live baseball and advocate for bicycle accommodations in Milwaukee and
			the stadium district.</h2> <p data-svelte-h="svelte-znq1hv">Visit <a href="/faq">FAQ</a> to learn more.</p> <div><h2 class="text-primary font-serif pt-10" data-svelte-h="svelte-1wzojrj">Ride Schedule</h2> <ul class="">${each(games, (item) => {
