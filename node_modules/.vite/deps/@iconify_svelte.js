...
var file = "node_modules/@iconify/svelte/dist/Icon.svelte";
...
function create_else_block(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(span, file, 115, 2, 2119);
    },
    m: function mount(target, anchor) {
...
function create_if_block_1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(svg, file, 111, 2, 2051);
    },
    m: function mount(target, anchor) {
...
function instance($$self, $$props, $$invalidate) {
  ...
  $$self.$inject_state = ($$new_props) => {
    ...
    if ("counter" in $$props)
      $$invalidate(3, counter2 = $$new_props.counter);
    if ("data" in $$props)
